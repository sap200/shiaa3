...
describe("DistributionExtension", () => {
    ...
    describe("delegationRewards", () => {
        it("works", async () => {
            testutils_spec_1.pendingWithoutSimapp();
            const [client, tmClient] = await makeClientWithDistribution(testutils_spec_1.simapp.tendermintUrl);
            const response = await client.distribution.unverified.delegationRewards(testutils_spec_1.faucet.address0, testutils_spec_1.validator.validatorAddress);
    ...
    describe("delegationTotalRewards", () => {
        it("works", async () => {
            testutils_spec_1.pendingWithoutSimapp();
            const [client, tmClient] = await makeClientWithDistribution(testutils_spec_1.simapp.tendermintUrl);
            const response = await client.distribution.unverified.delegationTotalRewards(testutils_spec_1.faucet.address0);
            expect(response.rewards).toBeDefined();
            expect(response.rewards).not.toBeNull();
            tmClient.disconnect();
        });
    ...
    describe("delegatorValidators", () => {
        it("works", async () => {
            testutils_spec_1.pendingWithoutSimapp();
            const [client, tmClient] = await makeClientWithDistribution(testutils_spec_1.simapp.tendermintUrl);
            const response = await client.distribution.unverified.delegatorValidators(testutils_spec_1.faucet.address0);
    ...
    describe("delegatorWithdrawAddress", () => {
        it("works", async () => {
            testutils_spec_1.pendingWithoutSimapp();
            const [client, tmClient] = await makeClientWithDistribution(testutils_spec_1.simapp.tendermintUrl);
            const response = await client.distribution.unverified.delegatorWithdrawAddress(testutils_spec_1.faucet.address0);
    ...
    describe("validatorCommission", () => {
        it("works", async () => {
            testutils_spec_1.pendingWithoutSimapp();
            const [client, tmClient] = await makeClientWithDistribution(testutils_spec_1.simapp.tendermintUrl);
            const response = await client.distribution.unverified.validatorCommission(testutils_spec_1.validator.validatorAddress);
    ...
    describe("validatorOutstandingRewards", () => {
        it("works", async () => {
            testutils_spec_1.pendingWithoutSimapp();
            const [client, tmClient] = await makeClientWithDistribution(testutils_spec_1.simapp.tendermintUrl);
            const response = await client.distribution.unverified.validatorOutstandingRewards(testutils_spec_1.validator.validatorAddress);
            expect(response.rewards).toBeDefined();
            expect(response.rewards).not.toBeNull();
            tmClient.disconnect();
        });
    ...
    describe("validatorSlashes", () => {
        it("works", async () => {
            testutils_spec_1.pendingWithoutSimapp();
            const [client, tmClient] = await makeClientWithDistribution(testutils_spec_1.simapp.tendermintUrl);
            const response = await client.distribution.unverified.validatorSlashes(testutils_spec_1.validator.validatorAddress, 1, 5);
