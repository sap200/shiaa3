...
describe("StargateClient.getTx and .searchTx", () => {
    ...
    beforeAll(async () => {
        if (testutils_spec_1.simappEnabled()) {
            ...
            const unsuccessfulResult = await sendTokens(client, registry, wallet, unsuccessfulRecipient, launchpad_1.coins(123456700000000, "ucosm"), "Sending more than I can afford");
            ...
            const successfulResult = await sendTokens(client, registry, wallet, successfulRecipient, launchpad_1.coins(1234567, "ucosm"), "Something I can afford");
