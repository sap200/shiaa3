    ...
    describe("unverified", () => {
        describe("balance", () => {
            it("works for different existing balances", async () => {
                testutils_spec_1.pendingWithoutSimapp();
                const [client, tmClient] = await makeClientWithBank(testutils_spec_1.simapp.tendermintUrl);
                const response1 = await client.bank.unverified.balance(testutils_spec_1.unused.address, testutils_spec_1.simapp.denomFee);
                expect(response1).toEqual({
                    amount: testutils_spec_1.unused.balanceFee,
                    denom: testutils_spec_1.simapp.denomFee,
                });
                const response2 = await client.bank.unverified.balance(testutils_spec_1.unused.address, testutils_spec_1.simapp.denomStaking);
                expect(response2).toEqual({
                    amount: testutils_spec_1.unused.balanceStaking,
                    denom: testutils_spec_1.simapp.denomStaking,
                });
            ...
            it("returns zero for non-existent balance", async () => {
                testutils_spec_1.pendingWithoutSimapp();
                const [client, tmClient] = await makeClientWithBank(testutils_spec_1.simapp.tendermintUrl);
                const response = await client.bank.unverified.balance(testutils_spec_1.unused.address, "gintonic");
            ...
            it("returns zero for non-existent address", async () => {
                testutils_spec_1.pendingWithoutSimapp();
                const [client, tmClient] = await makeClientWithBank(testutils_spec_1.simapp.tendermintUrl);
                const response = await client.bank.unverified.balance(testutils_spec_1.nonExistentAddress, testutils_spec_1.simapp.denomFee);
                expect(response).toEqual({
                    amount: "0",
                    denom: testutils_spec_1.simapp.denomFee,
                });
        ...
        describe("allBalances", () => {
            it("returns all balances for unused account", async () => {
                testutils_spec_1.pendingWithoutSimapp();
                const [client, tmClient] = await makeClientWithBank(testutils_spec_1.simapp.tendermintUrl);
                const balances = await client.bank.unverified.allBalances(testutils_spec_1.unused.address);
            ...
            it("returns an empty list for non-existent account", async () => {
                testutils_spec_1.pendingWithoutSimapp();
                const [client, tmClient] = await makeClientWithBank(testutils_spec_1.simapp.tendermintUrl);
                const balances = await client.bank.unverified.allBalances(testutils_spec_1.nonExistentAddress);
                expect(balances).toEqual([]);
                tmClient.disconnect();
            });
        });
        ...
        describe("supplyOf", () => {
            it("works for existing denom", async () => {
                testutils_spec_1.pendingWithoutSimapp();
                const [client, tmClient] = await makeClientWithBank(testutils_spec_1.simapp.tendermintUrl);
                const response = await client.bank.unverified.supplyOf(testutils_spec_1.simapp.denomFee);
                expect(response).toEqual({
                    amount: "18000000000",
                    denom: testutils_spec_1.simapp.denomFee,
                });
