...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.AssetsPacketData
	...
	case *types.AssetsPacketData_IbcAssetPacket:
		packetAck, err := am.keeper.OnRecvIbcAssetPacket(ctx, modulePacket, *packet.IbcAssetPacket)
		if err != nil {
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.AssetsPacketData_IbcAssetPacket:
		err := am.keeper.OnAcknowledgementIbcAssetPacket(ctx, modulePacket, *packet.IbcAssetPacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeIbcAssetPacket
	default:
		errMsg := fmt.Sprintf("unrecognized %s packet type: %T", types.ModuleName, packet)
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.AssetsPacketData_IbcAssetPacket:
		err := am.keeper.OnTimeoutIbcAssetPacket(ctx, modulePacket, *packet.IbcAssetPacket)
		if err != nil {
			return nil, err
		}
	default:
